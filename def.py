...
#SECOND DF - Build a DF function that uses get_dummies to encode the categorical columns
...
#LR with oversampled data

def sample_1(RandomOverSampler, lr_model):
    ...
    #we'll let the model make its predictions on the features
...
def sample_1(RandomUnderSampler, lr_model):
